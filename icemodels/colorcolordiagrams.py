...
example_plots = [
    ...
    },
    {
        ...
        'icemol': 'H2O',
        'abundance_wrt_h2': oxygen_abundance*0.25,
        'max_column': 5e20,
        'nh_to_av': 2e20,
        'av_start': 0,
        'label_author': True,
        'label_temperature': True,
        'title': f"Pure H$_2$O, $N(\\mathrm{{H_2O}}) = {_fmt_sci(oxygen_abundance*0.25)}\\,N(\\mathrm{{H_2}})$, G/D=10",
        'filename': 'CCD_icemodel_F356W-F444W_F405N-F466N_H2Oallvariants_gdr10_25pct_nodata.png',
        'icemix_name': 'H2Oallvariants_gdr10_25pct',
    },
